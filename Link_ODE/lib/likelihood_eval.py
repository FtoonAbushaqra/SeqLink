...
###########################
# Modified by Futoon M. Abu Shaqra: changed the loss
...
def compute_binary_CE_loss(label_predictions, mortality_label):
	...
	#ce_loss = nn.CrossEntropyLoss()(label_predictions, mortality_label)
	# ce_loss = nn.MSELoss()(label_predictions, mortality_label)
