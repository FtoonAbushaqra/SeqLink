...
class ODE_RNN(Baseline):
	...
	def get_reconstruction(self, time_steps_to_predict, data, truth_time_steps, 
		mask = None, n_traj_samples = None, mode = None,GODEL4 = None, GODEL3 = None,GODEL2 = None,GODEL1 = None ):
		...
		data_and_mask_and_latent = torch.cat([GODEL4, GODEL3, GODEL2, GODEL1, data, mask], -1)
		_, _, latent_ys, _ = self.ode_gru.run_odernn(
			data_and_mask, data_and_mask_and_latent, truth_time_steps, run_backwards = False)
