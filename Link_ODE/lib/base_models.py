...
###########################
# Modified by Futoon M. AbuShaqra
import numpy as np
import torch
...
class Baseline(nn.Module):
	...
	def compute_all_losses(self, batch_dict,
		...
		# Modified by Futoon M. AbuShaqra: Adding the labels
		pred_x, info = self.get_reconstruction(batch_dict["tp_to_predict"], 
			...
			mode = batch_dict["mode"], GODEL4 = batch_dict["GODEL4"], GODEL3 = batch_dict["GODEL3"],
											   GODEL2 = batch_dict["GODEL2"], GODEL1 = batch_dict["GODEL1"])
