...
def get_next_batch(dataloader):
	...
	batch_dict["GODEL4"] = data_dict["GODEL4"]
	batch_dict["GODEL3"] = data_dict["GODEL3"]
	batch_dict["GODEL2"] = data_dict["GODEL2"]
	batch_dict["GODEL1"] = data_dict["GODEL1"]
...
def split_data_extrap(data_dict, dataset = ""):
	...
	split_dict["GODEL4"] = None
	split_dict["GODEL3"] = None
	split_dict["GODEL2"] = None
	split_dict["GODEL1"] = None
	...
	split_dict["GODEL4"] = data_dict["GODEL4"].clone()
	split_dict["GODEL3"] = data_dict["GODEL3"].clone()
	split_dict["GODEL2"] = data_dict["GODEL2"].clone()
	split_dict["GODEL1"] = data_dict["GODEL1"].clone()
...
def subsample_observed_data(data_dict, n_tp_to_sample = None, n_points_to_cut = None):
	...
	if n_tp_to_sample is not None:
		...
		#print ("n_tp_to_sample is True")
		data, time_steps, mask = cut_out_timepoints(
			data_dict["observed_data"].clone(),
			time_steps = data_dict["observed_tp"].clone(),
			mask = (data_dict["observed_mask"].clone() if data_dict["observed_mask"] is not None else None),
			n_points_to_cut = n_tp_to_sample)
